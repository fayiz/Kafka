...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"co.fayiz.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":[\"string\",\"null\"]},{\"name\":\"email_address\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static co.fayiz.avro.Student.Builder newBuilder() {
    return new co.fayiz.avro.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static co.fayiz.avro.Student.Builder newBuilder(co.fayiz.avro.Student.Builder other) {
    return new co.fayiz.avro.Student.Builder(other);
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static co.fayiz.avro.Student.Builder newBuilder(co.fayiz.avro.Student other) {
    return new co.fayiz.avro.Student.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.fayiz.avro.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.fayiz.avro.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.fayiz.avro.Student.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.fayiz.avro.Student.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.fayiz.avro.Student.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.fayiz.avro.Student.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.fayiz.avro.Student.Builder setEmailAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.fayiz.avro.Student.Builder clearEmailAddress() {
      email_address = null;
